...
#
# Instructions:
# Download build script: wget https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/helm/3.0.3/build_helm.sh
...
CONF_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Helm/3.0.3/patch"
FORCE="false"
TEST="false"
GOPATH="${CURDIR}"
...
function configureAndInstall() {
	...
	wget https://storage.googleapis.com/golang/go1.13.7.linux-s390x.tar.gz
	chmod ugo+r go1.13.7.linux-s390x.tar.gz
